...
static void cull_queue(void) {
  ...
  //initialize all bits of temp_v to 1, ȫ 1 ��ʾ��û�б����ǵ���Ϊ 0 �ͱ�ʾ�����ǵ��ˡ�����ĸ���ָ���Ƿ�֧�ĸ��ǣ��ԣ���
...
static u8 fuzz_one(char** argv) {
  ...
  if (pending_favored) {  
    ...
    if ((queue_cur->was_fuzzed || !queue_cur->favored) &&
        UR(100) < SKIP_TO_NEW_PROB) return 1; // UR(100), 0-100 ֮ǰ
